...
static void do_linker(char *middle, int middle_len, char *binary, int *p_binary_len) {
	...
	eh->e_entry = 0x1000+header_size;                /* Entry point virtual address */
	...
	ph3->p_offset = header_size;               /* Segment file offset */
	ph3->p_vaddr = 0x1000+header_size;                /* Segment virtual address */
	ph3->p_paddr = 0x1000+header_size;                /* Segment physical address */
